...
import 'package:cultulingo/intermediate/jars/quiz7.dart';

class JarsQuiz6Page extends StatefulWidget {
  final int score;

  const JarsQuiz6Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz6Page();
}

class _Quiz6Page extends State<JarsQuiz6Page> {
  ...
  Future<void> _playAudio() async {
    await _audioPlayer.play(AssetSource('audio/quizjars6.mp3'));
  }
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => JarsQuiz7Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
