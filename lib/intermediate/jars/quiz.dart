...
class JarsQuizPage extends StatefulWidget {
  final String courseTitle;

  const JarsQuizPage({super.key, required this.courseTitle});

  @override
  State<StatefulWidget> createState() => _QuizPage();
}

class _QuizPage extends State<JarsQuizPage> {
  @override
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.pushNamed(
                            context, '/intermediate/jars/quiz1');
                      },
                      child: Container(
                        width: 200,
                        height: 50,
