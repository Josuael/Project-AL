...
class MountainQuizPage extends StatefulWidget {
  final String courseTitle;

  const MountainQuizPage({super.key, required this.courseTitle});

  @override
  State<StatefulWidget> createState() => _QuizPage();
}

class _QuizPage extends State<MountainQuizPage> {
  @override
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.pushNamed(
                            context, '/intermediate/mountain/quiz1');
                      },
                      child: Container(
                        width: 200,
                        height: 50,
