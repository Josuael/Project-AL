...
import 'package:cultulingo/intermediate/mountain/quiz5.dart'; // Import halaman Quiz 2

class MountainQuiz4Page extends StatefulWidget {
  final int score;

  const MountainQuiz4Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz4Page();
}

class _Quiz4Page extends State<MountainQuiz4Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'Dewi Jurangga transformed into the mountain called ___.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => MountainQuiz5Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
