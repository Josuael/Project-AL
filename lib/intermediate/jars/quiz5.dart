...
import 'package:cultulingo/intermediate/jars/quiz6.dart'; // Import halaman Quiz 2

class JarsQuiz5Page extends StatefulWidget {
  final int score;

  const JarsQuiz5Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz5Page();
}

class _Quiz5Page extends State<JarsQuiz5Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['Java', 'Bali', 'Borneo', 'Sumatra'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        ' According to legend, the missing water jars fled to the island of ______.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => JarsQuiz6Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
