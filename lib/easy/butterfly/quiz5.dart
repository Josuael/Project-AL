...
import 'package:cultulingo/easy/butterfly/quiz6.dart'; // Import halaman Quiz 2

class ButterflyQuiz5Page extends StatefulWidget {
  final int score;

  const ButterflyQuiz5Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz5Page();
}

class _Quiz5Page extends State<ButterflyQuiz5Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'What is the synonym of "dreadful" in, "something dreadful did happen"?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              ButterflyQuiz6Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
