...
import 'package:cultulingo/intermediate/waru/quiz5.dart'; // Import halaman Quiz 2

class WaruQuiz4Page extends StatefulWidget {
  final int score;

  const WaruQuiz4Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz4Page();
}

class _Quiz4Page extends State<WaruQuiz4Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'The Javanese believe that a lance shaft made of waru wood grants the bearer _____ in battle.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => WaruQuiz5Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
