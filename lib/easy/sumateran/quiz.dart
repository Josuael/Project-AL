...
class SumatranQuizPage extends StatefulWidget {
  final String courseTitle;

  const SumatranQuizPage({super.key, required this.courseTitle});

  @override
  State<StatefulWidget> createState() => _QuizPage();
}

class _QuizPage extends State<SumatranQuizPage> {
  @override
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.pushNamed(context, '/easy/sumateran/quiz1');
                      },
                      child: Container(
                        width: 200,
                        height: 50,
