...
import 'package:cultulingo/easy/butterfly/quiz3.dart'; // Import halaman Quiz 2

class ButterflyQuiz2Page extends StatefulWidget {
  final int score;

  const ButterflyQuiz2Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz2Page();
}

class _Quiz2Page extends State<ButterflyQuiz2Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'What is the synonym of "sighing" in the phrase, "the wind sighed softly through the tall trees"?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              ButterflyQuiz3Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
