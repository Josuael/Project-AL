...
class BorneoIntroducePage extends StatefulWidget {
  final String courseTitle; // Add the courseTitle parameter

  const BorneoIntroducePage({Key? key, required this.courseTitle})
...
class _IntroducePageState extends State<BorneoIntroducePage> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              _buildContentItem(
                ...
                () {
                  Navigator.pushNamed(context, '/hard/borneo/introduction');
                },
              ),
              _buildContentItem(
                'Reading',
