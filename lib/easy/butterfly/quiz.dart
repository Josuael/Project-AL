...
class ButterflyQuizPage extends StatefulWidget {
  final String courseTitle;

  const ButterflyQuizPage({super.key, required this.courseTitle});

  @override
  State<StatefulWidget> createState() => _QuizPage();
}

class _QuizPage extends State<ButterflyQuizPage> {
  @override
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.pushNamed(context, '/easy/butterfly/quiz1');
                      },
                      child: Container(
                        width: 200,
                        height: 50,
