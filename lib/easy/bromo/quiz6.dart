...
import 'package:cultulingo/easy/bromo/quiz7.dart'; // Import halaman Quiz 2

class BromoQuiz6Page extends StatefulWidget {
  final int score;

  const BromoQuiz6Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz6Page();
}

class _Quiz6Page extends State<BromoQuiz6Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'What is the synonym of "grieved" in the sentence, "He spoke in a soft, grieved voice"?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BromoQuiz7Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
