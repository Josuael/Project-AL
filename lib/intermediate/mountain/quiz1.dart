...
import 'package:cultulingo/intermediate/mountain/quiz2.dart'; // Import halaman Quiz 2

class MountainQuiz1Page extends StatefulWidget {
  final int score;

  const MountainQuiz1Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz1Page();
}

class _Quiz1Page extends State<MountainQuiz1Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['Indra', 'Brahma', 'Bromo', 'Smeru'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'The raksasa was appointed as a guardian by ___.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => MountainQuiz2Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
