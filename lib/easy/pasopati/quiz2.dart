...
import 'package:cultulingo/easy/pasopati/quiz3.dart'; // Import halaman Quiz 3

class PasopatiQuiz2Page extends StatefulWidget {
  final int score; // Menambahkan parameter score dari Quiz 1

  const PasopatiQuiz2Page({super.key, required this.score});

  @override
  State<StatefulWidget> createState() => _Quiz2Page();
}

class _Quiz2Page extends State<PasopatiQuiz2Page> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Teks pertanyaan
                      _textTheme(
                        'The word forefront in "He was always in the forefront" most closely means:',
                        20, // Ukuran font
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                          ...
                          child: _container(
                            ...
                            child: Center(
                              child: Padding(
                                ...
                                child: _textTheme(
                                  answerOptions[
                                      i], // Gunakan opsi jawaban di sini
                                  20,
                                  'Inter-Bold',
                                  TextAlign.center,
                                ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PasopatiQuiz3Page(
