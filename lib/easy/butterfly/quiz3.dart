...
import 'package:cultulingo/easy/butterfly/quiz4.dart'; // Import halaman Quiz 2

class ButterflyQuiz3Page extends StatefulWidget {
  final int score;

  const ButterflyQuiz3Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz3Page();
}

class _Quiz3Page extends State<ButterflyQuiz3Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['Surprise', 'Anger', 'Fear', 'Joy'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'What is the synonym of "astonishment" as in, "to the great astonishment of the white crow"?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              ButterflyQuiz4Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
