...
import 'package:cultulingo/intermediate/sawah/quiz4.dart'; // Import halaman Quiz 2

class SawahQuiz3Page extends StatefulWidget {
  final int score;

  const SawahQuiz3Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz3Page();
}

class _Quiz3Page extends State<SawahQuiz3Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['temple', 'house', 'sawah', 'bufallo'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'Randa Derma decided to hire Dongso to work on her small ______.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SawahQuiz4Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
