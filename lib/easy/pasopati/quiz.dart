...
class PasopatiQuizPage extends StatefulWidget {
  final String courseTitle;

  const PasopatiQuizPage({super.key, required this.courseTitle});

  @override
  State<StatefulWidget> createState() => _QuizPage();
}

class _QuizPage extends State<PasopatiQuizPage> {
  @override
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.pushNamed(context, '/easy/pasopati/quiz1');
                      },
                      child: Container(
                        width: 200,
                        height: 50,
