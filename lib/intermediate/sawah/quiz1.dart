...
import 'package:cultulingo/intermediate/sawah/quiz2.dart'; // Import halaman Quiz 2

class SawahQuiz1Page extends StatefulWidget {
  final int score;

  const SawahQuiz1Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz1Page();
}

class _Quiz1Page extends State<SawahQuiz1Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'Dongso was dismissed by the widow because the rice stalks were ______.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SawahQuiz2Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
