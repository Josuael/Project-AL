...
import 'package:cultulingo/intermediate/sawah/quiz5.dart'; // Import halaman Quiz 2

class SawahQuiz4Page extends StatefulWidget {
  final int score;

  const SawahQuiz4Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz4Page();
}

class _Quiz4Page extends State<SawahQuiz4Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['golden', 'full', 'empty', 'damaged'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'The rice stalks in Randa Derma\'s sawah looked promising but carried ______ ears.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SawahQuiz5Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
