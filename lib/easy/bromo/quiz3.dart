...
import 'package:cultulingo/easy/bromo/quiz4.dart'; // Import halaman Quiz 2

class BromoQuiz3Page extends StatefulWidget {
  final int score;

  const BromoQuiz3Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz3Page();
}

class _Quiz3Page extends State<BromoQuiz3Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['Happy', 'Content', 'Hungry', 'Confused'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'What is the synonym of "satisfied" as in, "Drink of this coffee until you are satisfied"?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BromoQuiz4Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
