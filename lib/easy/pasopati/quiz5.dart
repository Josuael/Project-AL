...
import 'package:cultulingo/easy/pasopati/quiz6.dart'; // Import halaman Quiz 3

class PasopatiQuiz5Page extends StatefulWidget {
  final int score; // Menambahkan parameter score dari Quiz 1

  const PasopatiQuiz5Page({super.key, required this.score});

  @override
  State<StatefulWidget> createState() => _Quiz5Page();
}

class _Quiz5Page extends State<PasopatiQuiz5Page> {
  final int correctAnswerIndex =
      1; // Jawaban yang benar adalah indeks 2 (A Hermit)
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Teks pertanyaan
                      _textTheme(
                        'The word amazement in "The king and the nobles were lost in amazement" is closest to:',
                        20, // Ukuran font
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                          ...
                          child: _container(
                            ...
                            child: Center(
                              child: Padding(
                                ...
                                child: _textTheme(
                                  answerOptions[i], // Use answer options here
                                  20,
                                  'Inter-Bold',
                                  TextAlign.center,
                                ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              PasopatiQuiz6Page(score: totalScore),
                        ),
                      );
                    },
                    child: _textTheme(
