...
import 'package:cultulingo/easy/sumateran/quiz3.dart'; // Import halaman Quiz 2

class SumatranQuiz2Page extends StatefulWidget {
  final int score;

  const SumatranQuiz2Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz2Page();
}

class _Quiz2Page extends State<SumatranQuiz2Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['Slow', 'Rapid', 'Steady', 'Calm'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        ' What is the synonym of "swift" in the context of the river?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SumatranQuiz3Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
