...
import 'package:cultulingo/easy/sumateran/quiz5.dart'; // Import halaman Quiz 2

class SumatranQuiz4Page extends StatefulWidget {
  final int score;

  const SumatranQuiz4Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz4Page();
}

class _Quiz4Page extends State<SumatranQuiz4Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['Dried', 'Blossomed', 'Grew', 'Expanded'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'What is the synonym of "withered" as used to describe the fruits?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SumatranQuiz5Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
