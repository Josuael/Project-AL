...
import 'package:cultulingo/easy/butterfly/quiz5.dart'; // Import halaman Quiz 2

class ButterflyQuiz4Page extends StatefulWidget {
  final int score;

  const ButterflyQuiz4Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz4Page();
}

class _Quiz4Page extends State<ButterflyQuiz4Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'What is the synonym of "grieved" in the sentence, "She was deeply grieved by the cruel letter"?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              ButterflyQuiz5Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
