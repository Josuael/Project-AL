...
import 'package:cultulingo/easy/sumateran/quiz2.dart'; // Import halaman Quiz 2

class SumatranQuiz1Page extends StatefulWidget {
  final int score;

  const SumatranQuiz1Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz1Page();
}

class _Quiz1Page extends State<SumatranQuiz1Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['Thick', 'Sparse', 'Tranparent', 'Wide'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'What is the synonym of "dense" as used in the passage?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SumatranQuiz2Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
