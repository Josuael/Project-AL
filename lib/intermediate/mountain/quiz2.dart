...
import 'package:cultulingo/intermediate/mountain/quiz3.dart'; // Import halaman Quiz 2

class MountainQuiz2Page extends StatefulWidget {
  final int score;

  const MountainQuiz2Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz2Page();
}

class _Quiz2Page extends State<MountainQuiz2Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['sea', 'mountain', 'barier', 'valley'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'To win Dewi Jurangga, the raksasa had to create a ___ of sand around Mount Bromo.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => MountainQuiz3Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
