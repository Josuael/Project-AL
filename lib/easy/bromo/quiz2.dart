...
import 'package:cultulingo/easy/bromo/quiz3.dart'; // Import halaman Quiz 2

class BromoQuiz2Page extends StatefulWidget {
  final int score;

  const BromoQuiz2Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz2Page();
}

class _Quiz2Page extends State<BromoQuiz2Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'What is the synonym of "miraculous" in the sentence, "It was just a year after this miraculous visit"?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BromoQuiz3Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
