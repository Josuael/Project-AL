...
import 'package:cultulingo/intermediate/waru/quiz2.dart'; // Import halaman Quiz 2

class WaruQuiz1Page extends StatefulWidget {
  final int score;

  const WaruQuiz1Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz1Page();
}

class _Quiz1Page extends State<WaruQuiz1Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['roots', 'leaves', 'flowers', 'fruits'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'Each drop of the snake\'s venom turned into _____ as the tree grew.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => WaruQuiz2Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
