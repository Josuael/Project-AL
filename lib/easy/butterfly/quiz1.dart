...
import 'package:cultulingo/easy/butterfly/quiz2.dart'; // Import halaman Quiz 2

class ButterflyQuiz1Page extends StatefulWidget {
  final int score;

  const ButterflyQuiz1Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz1Page();
}

class _Quiz1Page extends State<ButterflyQuiz1Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['King', 'Warrior', 'Servant', 'Magician'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'What is the synonym of "monarch" as used in the sentence, "Rajah Banjir, the monarch of the rains, lived in his rainbow-colored palace"?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              ButterflyQuiz2Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
