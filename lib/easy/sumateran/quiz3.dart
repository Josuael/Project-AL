...
import 'package:cultulingo/easy/sumateran/quiz4.dart'; // Import halaman Quiz 2

class SumatranQuiz3Page extends StatefulWidget {
  final int score;

  const SumatranQuiz3Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz3Page();
}

class _Quiz3Page extends State<SumatranQuiz3Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['Peebly', 'Smooth', 'Sandy', 'Grassy'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'What is the synonym of "rocky" describing the hermit\'s cave?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SumatranQuiz4Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
