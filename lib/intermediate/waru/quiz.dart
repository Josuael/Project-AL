...
class WaruQuizPage extends StatefulWidget {
  final String courseTitle;

  const WaruQuizPage({super.key, required this.courseTitle});

  @override
  State<StatefulWidget> createState() => _QuizPage();
}

class _QuizPage extends State<WaruQuizPage> {
  @override
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.pushNamed(
                            context, '/intermediate/waru/quiz1');
                      },
                      child: Container(
                        width: 200,
                        height: 50,
