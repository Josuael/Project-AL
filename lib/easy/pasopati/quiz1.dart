...
import 'package:cultulingo/easy/pasopati/quiz2.dart'; // Import halaman Quiz 2

class PasopatiQuiz1Page extends StatefulWidget {
  final int score;

  const PasopatiQuiz1Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz1Page();
}

class _Quiz1Page extends State<PasopatiQuiz1Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'The word warlike in "He was so warlike that he counted his battles by the hundreds" most likely means:',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PasopatiQuiz2Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
