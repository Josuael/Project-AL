...
import 'package:cultulingo/intermediate/waru/quiz6.dart'; // Import halaman Quiz 2

class WaruQuiz5Page extends StatefulWidget {
  final int score;

  const WaruQuiz5Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz5Page();
}

class _Quiz5Page extends State<WaruQuiz5Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'The jealousy of the other hermits arose because Kawitjaksana was preferred by the _____ for his wisdom and advice.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => WaruQuiz6Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
