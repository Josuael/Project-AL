...
class WaruIntroducePage extends StatefulWidget {
  final String courseTitle;

  const WaruIntroducePage({Key? key, required this.courseTitle})
      : super(key: key);
...
class _SawahIntroducePageState extends State<WaruIntroducePage> {
  @override
