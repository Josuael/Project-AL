...
import 'package:cultulingo/easy/bromo/quiz5.dart'; // Import halaman Quiz 2

class BromoQuiz4Page extends StatefulWidget {
  final int score;

  const BromoQuiz4Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz4Page();
}

class _Quiz4Page extends State<BromoQuiz4Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['Ask', 'Command', 'Suggest', 'Ignore'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'What is the synonym of "demand" as in, "Brahma will demand your son"?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BromoQuiz5Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
