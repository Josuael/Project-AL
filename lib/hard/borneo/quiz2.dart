...
import 'package:cultulingo/hard/borneo/quiz3.dart'; // Import halaman Quiz 2

class BorneoQuiz2Page extends StatefulWidget {
  final int score;

  const BorneoQuiz2Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz2Page();
}

class _Quiz2Page extends State<BorneoQuiz2Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'The reaction of the tigers when they saw the mouse-deer return with a quill can be described as _____.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BorneoQuiz3Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
