...
import 'package:cultulingo/hard/borneo/quiz4.dart'; // Import halaman Quiz 2

class BorneoQuiz3Page extends StatefulWidget {
  final int score;

  const BorneoQuiz3Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz3Page();
}

class _Quiz3Page extends State<BorneoQuiz3Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'The message that the mouse-deer delivers to the tigers’ Rajah can be inferred as an _____.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BorneoQuiz4Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
