...
import 'package:cultulingo/intermediate/mountain/quiz4.dart'; // Import halaman Quiz 2

class MountainQuiz3Page extends StatefulWidget {
  final int score;

  const MountainQuiz3Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz3Page();
}

class _Quiz3Page extends State<MountainQuiz3Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'The mountain giant ___ to trick the raksasa into failing his task.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => MountainQuiz4Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
