...
import 'package:cultulingo/intermediate/jars/quiz3.dart'; // Import halaman Quiz 2

class JarsQuiz2Page extends StatefulWidget {
  final int score;

  const JarsQuiz2Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz2Page();
}

class _Quiz2Page extends State<JarsQuiz2Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['humble', 'wise', 'powerful', 'rich'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        ' Brahma instructed Kajangka to bring something to Rajah Pahit to make him ______ again.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => JarsQuiz3Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
