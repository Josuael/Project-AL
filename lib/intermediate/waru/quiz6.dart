...
import 'package:cultulingo/intermediate/waru/quiz7.dart';

class WaruQuiz6Page extends StatefulWidget {
  final int score;

  const WaruQuiz6Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz6Page();
}

class _Quiz6Page extends State<WaruQuiz6Page> {
  ...
  Future<void> _playAudio() async {
    await _audioPlayer.play(AssetSource('audio/quizwaru6.mp3'));
  }
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => WaruQuiz7Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
