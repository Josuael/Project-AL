...
import 'package:cultulingo/intermediate/jars/quiz5.dart'; // Import halaman Quiz 2

class JarsQuiz4Page extends StatefulWidget {
  final int score;

  const JarsQuiz4Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz4Page();
}

class _Quiz4Page extends State<JarsQuiz4Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'A violent thunderstorm caused the ______ water jars to disappear from the mountain.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => JarsQuiz5Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
