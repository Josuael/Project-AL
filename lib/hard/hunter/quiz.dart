...
class HunterQuizPage extends StatefulWidget {
  final String courseTitle;

  const HunterQuizPage({super.key, required this.courseTitle});

  @override
  State<StatefulWidget> createState() => _QuizPage();
}

class _QuizPage extends State<HunterQuizPage> {
  @override
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.pushNamed(context, '/hard/hunter/quiz1');
                      },
                      child: Container(
                        width: 200,
                        height: 50,
