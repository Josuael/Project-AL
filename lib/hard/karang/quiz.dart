...
class KarangQuizPage extends StatefulWidget {
  final String courseTitle;

  const KarangQuizPage({super.key, required this.courseTitle});

  @override
  State<StatefulWidget> createState() => _QuizPage();
}

class _QuizPage extends State<KarangQuizPage> {
  @override
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.pushNamed(context, '/hard/karang/quiz1');
                      },
                      child: Container(
                        width: 200,
                        height: 50,
