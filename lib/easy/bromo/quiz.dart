...
class BromoQuizPage extends StatefulWidget {
  final String courseTitle;

  const BromoQuizPage({super.key, required this.courseTitle});

  @override
  State<StatefulWidget> createState() => _QuizPage();
}

class _QuizPage extends State<BromoQuizPage> {
  @override
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.pushNamed(context, '/easy/bromo/quiz1');
                      },
                      child: Container(
                        width: 200,
                        height: 50,
