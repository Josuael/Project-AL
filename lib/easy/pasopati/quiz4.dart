...
import 'package:cultulingo/easy/pasopati/quiz5.dart'; // Import halaman Quiz 3

class PasopatiQuiz4Page extends StatefulWidget {
  final int score; // Menambahkan parameter score dari Quiz 1

  const PasopatiQuiz4Page({super.key, required this.score});

  @override
  State<StatefulWidget> createState() => _Quiz4Page();
}

class _Quiz4Page extends State<PasopatiQuiz4Page> {
  final int correctAnswerIndex =
      0; // Jawaban yang benar adalah indeks 2 (A Hermit)
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Teks pertanyaan
                      _textTheme(
                        'The word prophecy in "Pasopati spoke almost the selfsame words of prophecy" means:',
                        20, // Ukuran font
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              PasopatiQuiz5Page(score: totalScore),
                        ),
                      );
                    },
                    child: _textTheme(
