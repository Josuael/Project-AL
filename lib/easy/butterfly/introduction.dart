...
class ButterflyIntroductionPage extends StatelessWidget {
  final String courseTitle;

  const ButterflyIntroductionPage({Key? key, required this.courseTitle})
      : super(key: key);
              ...
              Positioned(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    Navigator.pushNamed(
                      context,
                      '/easy/butterfly/introduce', // Arahkan ke halaman Introduction
                    );
                  },
                ),
              ),
