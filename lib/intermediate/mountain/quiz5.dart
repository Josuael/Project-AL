...
import 'package:cultulingo/intermediate/mountain/quiz6.dart'; // Import halaman Quiz 2

class MountainQuiz5Page extends StatefulWidget {
  final int score;

  const MountainQuiz5Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz5Page();
}

class _Quiz5Page extends State<MountainQuiz5Page> {
  ...
  final List<String> answerOptions = [
    'the gods intervene',
    'Mount Bromo vanishes',
    'the giant is forgiven',
    'the raksasa completes his task'
  ];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'The Sand Sea must remain until ___ happens.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => MountainQuiz6Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
