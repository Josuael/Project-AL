...
import 'package:cultulingo/intermediate/sawah/quiz6.dart'; // Import halaman Quiz 2

class SawahQuiz5Page extends StatefulWidget {
  final int score;

  const SawahQuiz5Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz5Page();
}

class _Quiz5Page extends State<SawahQuiz5Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['rice', 'gold', 'wheat', 'silver'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'When Dongso discovered the rice stalks had kernels of ______, he was astonished.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SawahQuiz6Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
