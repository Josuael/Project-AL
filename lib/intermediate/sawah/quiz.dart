...
class SawahQuizPage extends StatefulWidget {
  final String courseTitle;

  const SawahQuizPage({super.key, required this.courseTitle});

  @override
  State<StatefulWidget> createState() => _QuizPage();
}

class _QuizPage extends State<SawahQuizPage> {
  @override
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.pushNamed(
                            context, '/intermediate/sawah/quiz1');
                      },
                      child: Container(
                        width: 200,
                        height: 50,
