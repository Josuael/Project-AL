...
import 'package:cultulingo/intermediate/sawah/quiz3.dart'; // Import halaman Quiz 2

class SawahQuiz2Page extends StatefulWidget {
  final int score;

  const SawahQuiz2Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz2Page();
}

class _Quiz2Page extends State<SawahQuiz2Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['generous', 'bad', 'helpful', 'strong'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'The widow dismissed Dongso because people whispered that he might be a ______ spirit.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => SawahQuiz3Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
