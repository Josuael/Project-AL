...
class BorneoQuizPage extends StatefulWidget {
  final String courseTitle;

  const BorneoQuizPage({super.key, required this.courseTitle});

  @override
  State<StatefulWidget> createState() => _QuizPage();
}

class _QuizPage extends State<BorneoQuizPage> {
  @override
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.pushNamed(context, '/hard/borneo/quiz1');
                      },
                      child: Container(
                        width: 200,
                        height: 50,
