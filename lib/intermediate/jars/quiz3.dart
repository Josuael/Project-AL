...
import 'package:cultulingo/intermediate/jars/quiz4.dart'; // Import halaman Quiz 2

class JarsQuiz3Page extends StatefulWidget {
  final int score;

  const JarsQuiz3Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz3Page();
}

class _Quiz3Page extends State<JarsQuiz3Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['jar', 'jewelry', 'pottery', 'weapon'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'Kajangka promised to teach Rajah Pahit the art of ______-making.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => JarsQuiz4Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
