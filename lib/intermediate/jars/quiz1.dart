...
import 'package:cultulingo/intermediate/jars/quiz2.dart'; // Import halaman Quiz 2

class JarsQuiz1Page extends StatefulWidget {
  final int score;

  const JarsQuiz1Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz1Page();
}

class _Quiz1Page extends State<JarsQuiz1Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'Rajah Pahit had to take his heirlooms to the ______ to pay his debts.',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => JarsQuiz2Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
