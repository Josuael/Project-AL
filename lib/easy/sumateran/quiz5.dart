...
import 'package:cultulingo/easy/sumateran/quiz6.dart'; // Import halaman Quiz 2

class SumatranQuiz5Page extends StatefulWidget {
  final int score;

  const SumatranQuiz5Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz5Page();
}

class _Quiz5Page extends State<SumatranQuiz5Page> {
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        ' What is the synonym of "amazed" in the phrase “to his amazement”?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              SumateranQuiz6Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
