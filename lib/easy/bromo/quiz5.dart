...
import 'package:cultulingo/easy/bromo/quiz6.dart'; // Import halaman Quiz 2

class BromoQuiz5Page extends StatefulWidget {
  final int score;

  const BromoQuiz5Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz5Page();
}

class _Quiz5Page extends State<BromoQuiz5Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['Help', 'Burden', 'Stress', 'Decor'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'What is the synonym of "support" in the phrase, "the support and pride of their old age"?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BromoQuiz6Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
