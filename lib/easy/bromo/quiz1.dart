...
import 'package:cultulingo/easy/bromo/quiz2.dart'; // Import halaman Quiz 2

class BromoQuiz1Page extends StatefulWidget {
  final int score;

  const BromoQuiz1Page({Key? key, required this.score}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _Quiz1Page();
}

class _Quiz1Page extends State<BromoQuiz1Page> {
  ...
  // Daftar opsi jawaban
  final List<String> answerOptions = ['Joy', 'Peace', 'Restlessness', 'Anger'];
              ...
              child: _container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      _textTheme(
                        'What is the synonym of "contentment" as used in the sentence, "They lived there in happiness and contentment"?',
                        20,
                        'Inter-Bold',
                        TextAlign.left,
                      ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => BromoQuiz2Page(score: score),
                        ),
                      );
                    },
                    child: _textTheme(
